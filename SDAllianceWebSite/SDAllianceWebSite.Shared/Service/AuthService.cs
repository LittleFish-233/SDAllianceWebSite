...
namespace SDAllianceWebSite.Shared.Service
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<ConfirmEmailRegisterResult> ConfirmEmailRegister(ConfirmEmailRegisterModel model)
        {
            ...
            string jsonContent = result.Content.ReadAsStringAsync().Result;
            ConfirmEmailRegisterResult obj = JsonSerializer.Deserialize<ConfirmEmailRegisterResult>(jsonContent, ToolHelper.options);
            return obj;
        }
