...
using SDAllianceWebSite.APIServer.Application.BackgroundTasks;

namespace SDAllianceWebSite.APIServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<AppDbContext>(options =>
                options.UseMySql(Configuration.GetConnectionString("SdaDBConnection"), ServerVersion.AutoDetect(Configuration.GetConnectionString("SdaDBConnection")),
                    o =>
                    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
         ...
         /*   if (env.IsDevelopment())
           ...
           /* }
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "SDAlliance API V1");
            });
